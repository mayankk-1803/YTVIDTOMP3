      ...
      {loading ? (
        ...
        <div className="glass p-12 rounded-3xl text-center flex flex-col items-center">
          ...
          <p className="text-gray-500 mt-2">
            Go to the home page to start converting your first video.
          </p>
        </div>
            ...
            >
              ...
              <div className="mb-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-sm text-gray-300 hover:text-white flex items-center gap-2 mb-1 truncate"
                >
              ...
              <div className="mt-auto">
                {item.status === 'completed' ? (
                  <a
                    href={`${API_URL}/api/download/${item._id}`} // 🔥 FIXED
                    download
